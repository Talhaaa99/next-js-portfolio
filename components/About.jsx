...
const About = () => {
  return (
    <div
      id="about"
      className="w-[480px] md:w-full md:h-screen flex items-center p-2 py-16"
    >
      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-2 justify-center gap-8">
        ...
        <div className="w-auto pt-6 h-auto m-auto shadow-xl shadow-grey-300 rounded-xl flex items-center justify-center hover:scale-105 ease-in duration-300">
          <Image
