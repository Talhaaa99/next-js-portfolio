...
const Main = () => {
  return (
    <div className="w-full h-[720px] lg:h-screen items-center text-center">
      <div className="z-[-40] absolute rotate-[360deg] -right-[100px] -top-[80px] ">
        <Image src="/assets/SuperToroid-1.png" width={364} height={322} />
      </div>
      <div className="hidden md:block z-[-40] absolute rotate-[340deg] -bottom-10 left-[60px] ">
      ...
      <div className="max-w-[1240px] mx-auto p-2 pl-[110px] h-full w-full flex justify-center items-center z-[30]">
        <div>
          ...
          <h1 className="py-2 px-4 text-gray-700">A Front-End Web Developer</h1>
          ...
          <div>
            <div className="grid grid-cols-2 items-center justify-between gap-2 w-[490px] mx-auto p-4">
              ...
              <div className="flex justify-between items-center rounded-xl shadow-md shadow-gray-300 p-3 hover:scale-105 ease-in duration-200  cursor- bg-white  ">
                <AiOutlineGoogle />
                <p className="text-[13px]">talha.toufeeq99@gmail.com</p>
              </div>
